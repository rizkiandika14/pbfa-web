                ...
                <div class="row feature-icons" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
                            <img src="{{ asset('FlexStart/assets/img/features-3.png') }}" class="img-fluid p-4"
                                alt="">
                        </div>
                ...
                <div class="row gy-4" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <img src="{{ asset('FlexStart/assets/img/pricing-free.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            ...
                            <img src="{{ asset('FlexStart/assets/img/pricing-starter.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box">
                            ...
                            <img src="{{ asset('FlexStart/assets/img/pricing-business.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="box">
                            ...
                            <img src="{{ asset('FlexStart/assets/img/pricing-ultimate.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                ...
                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('FlexStart/assets/img/portfolio/portfolio-1.jpg') }}" class="img-fluid"
                                alt="">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('FlexStart/assets/img/portfolio/portfolio-2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 3</h4>
                                <p>Web</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('FlexStart/assets/img/portfolio/portfolio-3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 2</h4>
                                <p>App</p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('FlexStart/assets/img/testimonials/testimonials-1.jpg') }}"
