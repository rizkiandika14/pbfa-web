            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="box">
                            <img src="{{ asset('FlexStart/assets/img/values-1.png') }}" class="img-fluid"
                                alt="">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="box">
                            <img src="{{ asset('FlexStart/assets/img/values-2.png') }}" class="img-fluid"
                                alt="">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                        <div class="box">
                            <img src="{{ asset('FlexStart/assets/img/values-3.png') }}" class="img-fluid"
                                alt="">
